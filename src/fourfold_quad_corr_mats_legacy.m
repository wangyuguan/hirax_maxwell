function [Cslp,Cx,Cy,Cz,info] = fourfold_quad_corr_mats_legacy( ...
    S1,S2,S3,S4,eps_quad,zk)
%FOURFOLD_QUAD_CORR_MATS_LEGACY Reuse one block row for four rotated surfaces.
%
% Original assembled-matrix version, kept as the reference that
% FOURFOLD_QUAD_CORR_MATS is checked against. It materializes all sixteen
% blocks and so uses four times the storage of the block form.
%
